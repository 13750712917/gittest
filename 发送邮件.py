...
class Emil(object):
    def denglu(self):
        ...
        # 邮箱账号
        self.mail_user = '13750712917@163.com'
        # 邮箱密码
        self.mail_pass = 'qwer1234tyuiop'

        # 发送方地址信息
        self.sender = '13750712917@163.com'
        # 接收方地址信息
        self.receivers = ['13525038273@163.com']
    def xie(self):
        # 邮件主题
